...
public class NestedOuterClass {
    ...
    private static String name = "NestedOuterClass";
    private int i;
    protected int j;
    int k;
    public int l;

    //NestedOuterClass constructor
    public NestedOuterClass(int i, int j, int k, int l) {
        this.i = i;
        this.j = j;
        this.k = k;
        this.l = l;
	...
	public static void main(String[] args) {
		NestedOuterClass outer = new NestedOuterClass(1, 2, 3, 4);
